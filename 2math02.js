...
var Library = {
  ...
  drawPairGame: function(params) {
    ...
    Paper.rect(55, 285, 120, 120).attr({
      'fill': 'white',
      'stroke': 'white',
      'cursor': 'pointer'
    });
    Paper.rect(185, 285, 120, 120).attr({
      'fill': 'white',
      'stroke': 'white',
      'cursor': 'pointer'
    });
    Paper.text(115, 370, '1').attr({
      'font-size': 55,
      'text-anchor': 'middle',
      'cursor': 'pointer'
    });
    Paper.text(245, 370, '5').attr({
      'font-size': 55,
      'text-anchor': 'middle',
      'cursor': 'pointer'
    });
